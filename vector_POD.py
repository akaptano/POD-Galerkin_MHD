...
def vector_POD(svd_mat,time,poly_order,threshold,num_POD):
    ...
    if num_POD!=3:
        ...
        ax3.plot(x_test[0:2,3],x_test[0:2,4],x_test[0:2,5], 'k')
        ...
        ax4.plot(x_test_sim[0:2,3],x_test_sim[0:2,4],x_test_sim[0:2,5], 'b--')
        ...
        ax5.plot(x_test[0:2,6],x_test[0:2,7],x_test[0:2,8], 'k')
        ...
        ax6.plot(x_test_sim[0:2,6],x_test_sim[0:2,7],x_test_sim[0:2,8], 'b--')
        #ax4.plot(x_test_sim_predict[:,3],x_test_sim_predict[:,4],x_test_sim_predict[:,5], 'r--')
        ...
        ax7.plot(x_test[0:2,9],x_test[0:2,10],x_test[0:2,11], 'k')
        ...
        ax8.plot(x_test_sim[0:2,9],x_test_sim[0:2,10],x_test_sim[0:2,11], 'b--')
        #ax4.plot(x_test_sim_predict[:,3],x_test_sim_predict[:,4],x_test_sim_predict[:,5], 'r--')
    ...
    fargs=(x_pred,x_test_sim,t_pred,num_POD),repeat=False, \
    ...
    n_jobs = 1
    yscale = 'log'
    thresholds=np.linspace(0,0.08,50)
